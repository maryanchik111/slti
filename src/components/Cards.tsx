    ...
    <Link href={`/servant/${servant.id}`} className="group block h-full">
      <div className="bg-white rounded-2xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 h-full flex flex-col border border-gray-100">
        <div className="relative h-72 flex-shrink-0 overflow-hidden">
          ...
          <div className={`absolute inset-0 bg-gradient-to-br from-amber-100 via-stone-100 to-amber-200 flex items-center justify-center ${imageSrc ? 'hidden' : 'flex'}`}>
            <div className="w-24 h-24 bg-white/40 rounded-2xl flex items-center justify-center backdrop-blur-sm shadow-lg">
              <svg className="w-14 h-14 text-amber-700" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="p-6 flex-grow flex flex-col bg-gradient-to-b from-white to-stone-50">
          ...
          <p className="text-amber-700 font-semibold mb-4 text-sm uppercase tracking-wide">
          ...
          <div className="mt-4 flex items-center text-amber-600 font-medium text-sm group-hover:text-amber-700 transition-colors">
...
export function EventCard({ event }: EventCardProps) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 border border-gray-100 group">
      <div className="relative h-52 bg-gradient-to-br from-amber-100 via-stone-100 to-amber-200 flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full shadow-md">
          <span className="text-xs font-bold text-amber-700 uppercase tracking-wider">Подія</span>
        </div>
      </div>
      <div className="p-6 bg-gradient-to-b from-white to-stone-50">
        <div className="flex items-center text-sm text-amber-700 mb-3 font-medium">
