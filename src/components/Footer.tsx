    ...
    <footer className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white border-t border-slate-700/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="w-10 h-10 flex items-center justify-center rounded-full bg-white/5 border border-white/10 text-gray-300 hover:text-white hover:bg-amber-600 hover:border-amber-600 transition-all duration-300"
              >
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-bold mb-5 text-amber-400">{t('footerQuickLinks')}</h4>
            <ul className="space-y-3">
              <li>
                <Link href="/" className="text-gray-300 hover:text-amber-400 transition-colors flex items-center group">
                  <span className="w-1.5 h-1.5 bg-amber-500 rounded-full mr-2 opacity-0 group-hover:opacity-100 transition-opacity"></span>
                  {t('home')}
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-gray-300 hover:text-amber-400 transition-colors flex items-center group">
                  <span className="w-1.5 h-1.5 bg-amber-500 rounded-full mr-2 opacity-0 group-hover:opacity-100 transition-opacity"></span>
                  {t('about')}
                </Link>
              </li>
              <li>
                <Link href="/sermons" className="text-gray-300 hover:text-amber-400 transition-colors flex items-center group">
                  <span className="w-1.5 h-1.5 bg-amber-500 rounded-full mr-2 opacity-0 group-hover:opacity-100 transition-opacity"></span>
                  {t('sermons')}
                </Link>
              </li>
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-lg font-bold mb-5 text-amber-400">{t('contact')}</h4>
            ...
            {/* Service Times */}
            <div className="mt-8">
              <h5 className="font-bold mb-3 text-amber-400 text-sm uppercase tracking-wide">{t('footerServiceSchedule')}</h5>
              <div className="text-sm text-gray-300 space-y-2">
                <div className="flex justify-between items-center py-1 border-b border-white/5">
                  <span>{t('footerSundayService')}</span>
                  <span className="text-amber-400 font-medium">{t('footerSundayTime')}</span>
                </div>
                <div className="flex justify-between items-center py-1 border-b border-white/5">
                  <span>{t('footerPrayerMeeting')}</span>
                  <span className="text-amber-400 font-medium">{t('footerThursdayTime')}</span>
                </div>
                <div className="flex justify-between items-center py-1 border-b border-white/5">
                  <span>{t('footerSundaySchool')}</span>
                  <span className="text-amber-400 font-medium">{t('footerSaturdaySchoolTime')}</span>
                </div>
                <div className="flex justify-between items-center py-1">
                  <span>{t('footerYouthService')}</span>
                  <span className="text-amber-400 font-medium">{t('footerSaturdayYouthTime')}</span>
                </div>
              </div>
            </div>
          </div>
