export const translations = {
  uk: {
    ...
    // Schedule
    sundayService: "Зібрання + дитяче служіння",
    prayer: "Молитва",
    sundaySchool: "Вивчення",
    youth: "Молодіжка",
    sunday: "Неділя 14:00",
    ...
    footerSundayService: "Зібрання + дитяче служіння",
    footerSundayTime: "Неділя 14:00",
    footerPrayerMeeting: "Молитва",
    footerThursdayTime: "Середа 19:00",
    footerSundaySchool: "Вивчення",
    footerSaturdaySchoolTime: "Четвер 19:00",
  ...
  en: {
    ...
    // Schedule
    sundayService: "Meeting + Children's Ministry",
    prayer: "Prayer",
    sundaySchool: "Study",
    youth: "Youth Group",
    ...
    footerSundayService: "Meeting + Children's Ministry",
    footerSundayTime: "Sunday 2:00 PM",
    footerPrayerMeeting: "Prayer",
    footerThursdayTime: "Wednesday 7:00 PM",
    footerSundaySchool: "Study",
    footerSaturdaySchoolTime: "Thursday 7:00 PM",
    footerYouthService: "Youth Service",
    footerSaturdayYouthTime: "Saturday 6:00 PM",
    followUs: "Follow Us",
    allRightsReserved: "All rights reserved",
    copyright: "© 2026 Tabernacle of Love and Truth. All rights reserved.",
